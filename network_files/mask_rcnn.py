...
class MaskRCNN(FasterRCNN):
    def __init__(
            ...
            backbone,
            num_classes=None,
            angle_num_classes=None,  # 新增 angle_num_classes 参数
            ...
            box_head=None,
            box_predictor=None,
            grasp_box_head=None,  # 新增 grasp_box_head 参数
            grasp_box_predictor=None,  # 新增 grasp_box_predictor 参数
        ...
        super().__init__(
            backbone,
            num_classes,
            angle_num_classes,  # 传递 angle_num_classes
            # transform parameters
            min_size,
            max_size,
            image_mean,
            ...
            box_head,
            box_predictor,
            grasp_box_head,  # 传递 grasp_box_head
            grasp_box_predictor,  # 传递 grasp_box_predictor
            box_score_thresh,
            box_nms_thresh,
